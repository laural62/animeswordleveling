        ...
        <header className="bg-black text-white flex justify-around items-center">
            ...
            {userConnected ? (
                ...
                <nav className="flex space-x-6">
                    ...
                    <NavLink to="/" className="text-white font-semibold hover:text-gray-300 hover:text-2xl">Nouveautes</NavLink>
                    <NavLink to="/" className="text-white font-semibold hover:text-gray-300 hover:text-2xl">Actualites</NavLink>
                    <NavLink to="/" className="text-white font-semibold hover:text-gray-300 hover:text-2xl">Streamer</NavLink>
                    <NavLink to="/" className="text-white font-semibold hover:text-gray-300 hover:text-2xl">A Propos</NavLink>
                    <NavLink to="/" className="text-white font-semibold hover:text-gray-300 hover:text-2xl">Contact</NavLink>
                    <NavLink
                        to="/"
